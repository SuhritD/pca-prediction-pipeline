...
preprocessing.py
The images must be skull-stripped and spatially normalized to match the MNI 1 mm resolution 182 x 218 x 182. This file uses the deep-learning HD-BET, which is run on Bash or Command Prompt, and the DWI_MNI_1 mm file in the repository. The instructions for installing it are here.
